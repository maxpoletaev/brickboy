...
gb_opcode_t gb_opcodes[256] = {
    ...
    GB_OPCODE(0x13, ARG_REG_DE, ARG_NONE, gb_inc_u16, "INC", 2),  // INC DE
    GB_OPCODE(0x23, ARG_REG_HL, ARG_NONE, gb_inc_u16, "INC", 2),  // INC HL
    GB_OPCODE(0x33, ARG_REG_SP, ARG_NONE, gb_inc_u16, "INC", 2),  // INC SP

    GB_OPCODE(0x04, ARG_REG_B, ARG_NONE, gb_inc_u8, "INC", 1),  // INC B
    GB_OPCODE(0x0C, ARG_REG_C, ARG_NONE, gb_inc_u8, "INC", 1),  // INC C
    GB_OPCODE(0x14, ARG_REG_D, ARG_NONE, gb_inc_u8, "INC", 1),  // INC D
    GB_OPCODE(0x1C, ARG_REG_E, ARG_NONE, gb_inc_u8, "INC", 1),  // INC E
    GB_OPCODE(0x24, ARG_REG_H, ARG_NONE, gb_inc_u8, "INC", 1),  // INC H
    GB_OPCODE(0x2C, ARG_REG_L, ARG_NONE, gb_inc_u8, "INC", 1),  // INC L
    GB_OPCODE(0x3C, ARG_REG_A, ARG_NONE, gb_inc_u8, "INC", 1),  // INC A
    GB_OPCODE(0x34, ARG_IND_HL, ARG_NONE, gb_inc_u8, "INC", 3), // INC (HL)

    GB_OPCODE(0x02, ARG_IND_BC, ARG_REG_A, gb_ld_u8, "LD", 2),  // LD (BC),A
    GB_OPCODE(0x0A, ARG_REG_A, ARG_IND_BC, gb_ld_u8, "LD", 2),  // LD A,(BC)
    GB_OPCODE(0x12, ARG_IND_DE, ARG_REG_A, gb_ld_u8, "LD", 2),  // LD (DE),A
    GB_OPCODE(0x1A, ARG_REG_A, ARG_IND_DE, gb_ld_u8, "LD", 2),  // LD A,(DE)
    GB_OPCODE(0x22, ARG_IND_HLI, ARG_REG_A, gb_ld_u8, "LD", 2), // LD (HL+),A
    GB_OPCODE(0x2A, ARG_REG_A, ARG_IND_HLI, gb_ld_u8, "LD", 2), // LD A,(HL+)
    GB_OPCODE(0x32, ARG_IND_HLD, ARG_REG_A, gb_ld_u8, "LD", 2), // LD (HL-),A
    GB_OPCODE(0x3A, ARG_REG_A, ARG_IND_HLD, gb_ld_u8, "LD", 2), // LD A,(HL-)
    GB_OPCODE(0x40, ARG_REG_B, ARG_REG_B, gb_ld_u8, "LD", 1),   // LD B,B
    GB_OPCODE(0x41, ARG_REG_B, ARG_REG_C, gb_ld_u8, "LD", 1),   // LD B,C
    GB_OPCODE(0x42, ARG_REG_B, ARG_REG_D, gb_ld_u8, "LD", 1),   // LD B,D
    GB_OPCODE(0x43, ARG_REG_B, ARG_REG_E, gb_ld_u8, "LD", 1),   // LD B,E
    GB_OPCODE(0x44, ARG_REG_B, ARG_REG_H, gb_ld_u8, "LD", 1),   // LD B,H
    GB_OPCODE(0x45, ARG_REG_B, ARG_REG_L, gb_ld_u8, "LD", 1),   // LD B,L
    GB_OPCODE(0x46, ARG_REG_B, ARG_IND_HL, gb_ld_u8, "LD", 2),  // LD B,(HL)
    GB_OPCODE(0x47, ARG_REG_B, ARG_REG_A, gb_ld_u8, "LD", 1),   // LD B,A
    GB_OPCODE(0x48, ARG_REG_C, ARG_REG_B, gb_ld_u8, "LD", 1),   // LD C,B
    GB_OPCODE(0x49, ARG_REG_C, ARG_REG_C, gb_ld_u8, "LD", 1),   // LD C,C
    GB_OPCODE(0x4A, ARG_REG_C, ARG_REG_D, gb_ld_u8, "LD", 1),   // LD C,D
    GB_OPCODE(0x4B, ARG_REG_C, ARG_REG_E, gb_ld_u8, "LD", 1),   // LD C,E
    GB_OPCODE(0x4C, ARG_REG_C, ARG_REG_H, gb_ld_u8, "LD", 1),   // LD C,H
    GB_OPCODE(0x4D, ARG_REG_C, ARG_REG_L, gb_ld_u8, "LD", 1),   // LD C,L
    GB_OPCODE(0x4E, ARG_REG_C, ARG_IND_HL, gb_ld_u8, "LD", 2),  // LD C,(HL)
    GB_OPCODE(0x4F, ARG_REG_C, ARG_REG_A, gb_ld_u8, "LD", 1),   // LD C,A
    GB_OPCODE(0x50, ARG_REG_D, ARG_REG_B, gb_ld_u8, "LD", 1),   // LD D,B
    GB_OPCODE(0x51, ARG_REG_D, ARG_REG_C, gb_ld_u8, "LD", 1),   // LD D,C
    GB_OPCODE(0x52, ARG_REG_D, ARG_REG_D, gb_ld_u8, "LD", 1),   // LD D,D
    GB_OPCODE(0x53, ARG_REG_D, ARG_REG_E, gb_ld_u8, "LD", 1),   // LD D,E
    GB_OPCODE(0x54, ARG_REG_D, ARG_REG_H, gb_ld_u8, "LD", 1),   // LD D,H
    GB_OPCODE(0x55, ARG_REG_D, ARG_REG_L, gb_ld_u8, "LD", 1),   // LD D,L
    GB_OPCODE(0x56, ARG_REG_D, ARG_IND_HL, gb_ld_u8, "LD", 2),  // LD D,(HL)
    GB_OPCODE(0x57, ARG_REG_D, ARG_REG_A, gb_ld_u8, "LD", 1),   // LD D,A
    GB_OPCODE(0x58, ARG_REG_E, ARG_REG_B, gb_ld_u8, "LD", 1),   // LD E,B
    GB_OPCODE(0x59, ARG_REG_E, ARG_REG_C, gb_ld_u8, "LD", 1),   // LD E,C
    GB_OPCODE(0x5A, ARG_REG_E, ARG_REG_D, gb_ld_u8, "LD", 1),   // LD E,D
    GB_OPCODE(0x5B, ARG_REG_E, ARG_REG_E, gb_ld_u8, "LD", 1),   // LD E,E
    GB_OPCODE(0x5C, ARG_REG_E, ARG_REG_H, gb_ld_u8, "LD", 1),   // LD E,H
    GB_OPCODE(0x5D, ARG_REG_E, ARG_REG_L, gb_ld_u8, "LD", 1),   // LD E,L
    GB_OPCODE(0x5E, ARG_REG_E, ARG_IND_HL, gb_ld_u8, "LD", 2),  // LD E,(HL)
    GB_OPCODE(0x5F, ARG_REG_E, ARG_REG_A, gb_ld_u8, "LD", 1),   // LD E,A
    GB_OPCODE(0x60, ARG_REG_H, ARG_REG_B, gb_ld_u8, "LD", 1),   // LD H,B
    GB_OPCODE(0x61, ARG_REG_H, ARG_REG_C, gb_ld_u8, "LD", 1),   // LD H,C
    GB_OPCODE(0x62, ARG_REG_H, ARG_REG_D, gb_ld_u8, "LD", 1),   // LD H,D
    GB_OPCODE(0x63, ARG_REG_H, ARG_REG_E, gb_ld_u8, "LD", 1),   // LD H,E
    GB_OPCODE(0x64, ARG_REG_H, ARG_REG_H, gb_ld_u8, "LD", 1),   // LD H,H
    GB_OPCODE(0x65, ARG_REG_H, ARG_REG_L, gb_ld_u8, "LD", 1),   // LD H,L
    GB_OPCODE(0x66, ARG_REG_H, ARG_IND_HL, gb_ld_u8, "LD", 2),  // LD H,(HL)
    GB_OPCODE(0x67, ARG_REG_H, ARG_REG_A, gb_ld_u8, "LD", 1),   // LD H,A
    GB_OPCODE(0x68, ARG_REG_L, ARG_REG_B, gb_ld_u8, "LD", 1),   // LD L,B
    GB_OPCODE(0x69, ARG_REG_L, ARG_REG_C, gb_ld_u8, "LD", 1),   // LD L,C
    GB_OPCODE(0x6A, ARG_REG_L, ARG_REG_D, gb_ld_u8, "LD", 1),   // LD L,D
    GB_OPCODE(0x6B, ARG_REG_L, ARG_REG_E, gb_ld_u8, "LD", 1),   // LD L,E
    GB_OPCODE(0x6C, ARG_REG_L, ARG_REG_H, gb_ld_u8, "LD", 1),   // LD L,H
    GB_OPCODE(0x6D, ARG_REG_L, ARG_REG_L, gb_ld_u8, "LD", 1),   // LD L,L
    GB_OPCODE(0x6E, ARG_REG_L, ARG_IND_HL, gb_ld_u8, "LD", 2),  // LD L,(HL)
    GB_OPCODE(0x6F, ARG_REG_L, ARG_REG_A, gb_ld_u8, "LD", 1),   // LD L,A
    GB_OPCODE(0x70, ARG_IND_HL, ARG_REG_B, gb_ld_u8, "LD", 2),  // LD (HL),B
    GB_OPCODE(0x71, ARG_IND_HL, ARG_REG_C, gb_ld_u8, "LD", 2),  // LD (HL),C
    GB_OPCODE(0x72, ARG_IND_HL, ARG_REG_D, gb_ld_u8, "LD", 2),  // LD (HL),D
    GB_OPCODE(0x73, ARG_IND_HL, ARG_REG_E, gb_ld_u8, "LD", 2),  // LD (HL),E
    GB_OPCODE(0x74, ARG_IND_HL, ARG_REG_H, gb_ld_u8, "LD", 2),  // LD (HL),H
    GB_OPCODE(0x75, ARG_IND_HL, ARG_REG_L, gb_ld_u8, "LD", 2),  // LD (HL),L
    GB_OPCODE(0x77, ARG_IND_HL, ARG_REG_A, gb_ld_u8, "LD", 2),  // LD (HL),A
    GB_OPCODE(0x78, ARG_REG_A, ARG_REG_B, gb_ld_u8, "LD", 1),   // LD A,B
    GB_OPCODE(0x79, ARG_REG_A, ARG_REG_C, gb_ld_u8, "LD", 1),   // LD A,C
    GB_OPCODE(0x7A, ARG_REG_A, ARG_REG_D, gb_ld_u8, "LD", 1),   // LD A,D
    GB_OPCODE(0x7B, ARG_REG_A, ARG_REG_E, gb_ld_u8, "LD", 1),   // LD A,E
    GB_OPCODE(0x7C, ARG_REG_A, ARG_REG_H, gb_ld_u8, "LD", 1),   // LD A,H
    ...
    GB_OPCODE(0x21, ARG_REG_HL, ARG_IMM16, gb_ld_u16, "LD", 3),  // LD HL,d16
    GB_OPCODE(0x31, ARG_REG_SP, ARG_IMM16, gb_ld_u16, "LD", 3),  // LD SP,d16
    GB_OPCODE(0x08, ARG_IND16, ARG_REG_SP, gb_ld_u16, "LD", 5),  // LD (a16),SP
    GB_OPCODE(0xF9, ARG_REG_SP, ARG_REG_HL, gb_ld_u16, "LD", 2), // LD SP,HL

    GB_OPCODE(0x80, ARG_REG_A, ARG_REG_B, gb_add_u8, "ADD", 1),  // ADD A,B
    GB_OPCODE(0x81, ARG_REG_A, ARG_REG_C, gb_add_u8, "ADD", 1),  // ADD A,C
    GB_OPCODE(0x82, ARG_REG_A, ARG_REG_D, gb_add_u8, "ADD", 1),  // ADD A,D
    GB_OPCODE(0x83, ARG_REG_A, ARG_REG_E, gb_add_u8, "ADD", 1),  // ADD A,E
    GB_OPCODE(0x84, ARG_REG_A, ARG_REG_H, gb_add_u8, "ADD", 1),  // ADD A,H
